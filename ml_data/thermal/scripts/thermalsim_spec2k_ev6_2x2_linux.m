...
simtime=hotspotl_gridsim_linux(ptrace,mpsoc_flp_file,mpsoc_config_file,ss_trace,'64','64', '')
history.simtime{j}=simtime;
history.powertr_file{j}=powertr_file;
history.tempss_file{j}=ss_trace;
...
save('./mpsoc_traces/history_linux.mat',  'history')
cd ('../../Hotspot')
