function  joinedcore_flp= join_flps( core1_flp, core2_flp, position)
%Tis is same as join_flp but bases are adjusted
...
switch position
    ...
    case 'left'
        ...
        joinedcore_flp.BaseX=min(joinedcore_flp.x);
        joinedcore_flp.BaseY=min(joinedcore_flp.y);
